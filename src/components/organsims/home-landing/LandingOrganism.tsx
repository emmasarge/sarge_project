...
export const LandingOrgansim: FunctionComponent = () => {
  ...
  return (
    <div
      id="home-hero"
      className={`container mt-20 mb-10  max-w-[1900px] mx-auto ${
        isScrolled
    ...
    >
      ...
      >
        <div className="flex flex-col h-full mb-20 w-11/12 lg:pl-10 lg:w-[60%]  static py-30 z-10 justify-center items-center mt-[-10%]  lg:-mt-[8%]">
          <div className=" flex flex-col  py-10 h-max text-dark w-11/12   pb-30 ">
            ...
            <Link
                className="text-dark border border-dark rounded-full   pt-[0.125em] pb-[0.15em] px-[1.5em] text-[1.45em]    tracking-wide shadow-sm transition duration-300 hover:duration-300 hover:scale-105 cursor-pointer"
                to="/portfolio"
      ...
      {isMobile && <ScrollLink to="scroll-section" smooth={true} duration={300}>
            <div className=" scroll-section  w-10/12 h-[100%] flex justify-between items-stretch flex-shrink flex-row">
            <Parallax startScroll={2}  scaleZ={[1.2, 1]} speed={5} translateX={[210, 20]} translateY={[-10, -50]} className="flex w-auto" >
              ...
              <Parallax  startScroll={1} speed={3} scaleZ={[1, 1.5]} translateX={[-40, 50]} translateY={[290, -10]} className="flex w-auto -z-50" >

          
              <div className="w-[85vw] h-[85vw] sm:w-[20em] sm:h-[20em] lg:mt-20 relative mt-[-6%] lg:static lg:w-[30vw] lg:h-[30vw] box rounded-full color-background-1 bg-blend-difference opacity-90   "></div>
            </Parallax>
            </div>
          </ScrollLink>}
       {isTablet &&   <ScrollLink to="scroll-section" smooth={true} duration={300}>
            <div className=" scroll-section  w-10/12 h-[80%] flex justify-between items-stretch flex-shrink flex-row mt-[1.25em]">
            <Parallax startScroll={2}  scaleZ={[1.2, 1]} speed={5} translateX={[-130, 200]} translateY={[-20, -30]} className="flex w-auto" >

             
              <div className="w-[95vw] h-[95vw] sm:w-[30em] sm:h-[30em]  lg:-mt-32 relative -mt-[20%] lg:static lg:w-[30vw] lg:h-[30vw] box-2 rounded-full color-background-2  bg-blend-hard-light"></div>
              </Parallax>


              <Parallax  startScroll={1} speed={3} scaleZ={[1, 1.5]} translateX={[20, -50]} translateY={[-10, 200]} className="flex w-auto -z-50" >

          
              <div className="w-[85vw] h-[85vw] sm:w-[30em] sm:h-[30em] lg:mt-20 relative  lg:static lg:w-[30vw] lg:h-[30vw] box rounded-full color-background-1 bg-blend-difference opacity-90   "></div>
            </Parallax>
            </div>
          </ScrollLink>}
          {!isMobile && !isTablet &&  <ScrollLink to="scroll-section" smooth={true} duration={300}>
            <div className=" scroll-section  w-10/12 max-w-[400px] h-[60vh] flex justify-between items-stretch flex-shrink flex-row">
            <Parallax startScroll={2}  scaleZ={[1.2, 1]} speed={5} translateX={[200, 80]} translateY={[-10, -20]} className="flex w-auto" >
              ...
              <Parallax  startScroll={1} speed={3} scaleZ={[1, 1.5]} translateX={[-90, 90]} translateY={[60, -20]} className="flex w-auto -z-50" >
