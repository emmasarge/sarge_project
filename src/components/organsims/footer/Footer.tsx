...
export const FooterOrganism = () => {
    return (  
        <footer className="w-full footer h-fit  bottom-0 shadow pt-1 pb-8  bg-offWhite flex flex-row justify-center items-center z-50">
            <div className="w-11/12 relative h-full flex flex-row justify-start items-start">
